...
/**
 * @dev Contract for AFOT Coin
 */
contract AFOT is Pausable, Ownable, Burnable, Lockable, ERC20 {

  uint private constant _initialSupply = 3_500_000_000e18; // 3.5 billion

  constructor() ERC20("allforone token", "AFOT") public {
